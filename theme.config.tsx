...
const config: DocsThemeConfig = {
  logo: (
    <div className="flex items-center gap-2">
      <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="32" height="32" className="fill-[#1D4528] dark:fill-white">
      ...
      <span className="font-bold text-[#1D4528] dark:text-white">Metrists</span>
    </div>
  ),
  project: {
  ...
  footer: {
    text: (
      <div className="text-center">
        <p>© {new Date().getFullYear()} Metrists. <a href="https://github.com/metrists/metrists" target="_blank" rel="noopener noreferrer" className="hover:text-[#1D4528] transition-colors duration-200">Proudly Open-Source</a>.</p>
      </div>
    ),
  },
  primaryHue: {
  ...
  head: (
    <>
      ...
      <style jsx global>{`
        ...
        .nextra-content h1, .nextra-content h2, .nextra-content h3, .nextra-content h4, .nextra-content h5, .nextra-content h6 {
        ...
        body::before {
          ...
          width: 100%;
          height: 100%;
          background: radial-gradient(circle at 25% 25%, rgba(139, 69, 19, 0.01) 0%, transparent 50%),
            radial-gradient(circle at 75% 75%, rgba(160, 82, 45, 0.01) 0%, transparent 50%),
